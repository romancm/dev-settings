                ...
                <el-row :gutter="20">
                    <el-col :xs="24" v-for="gist in gists" :key="gist.id">
                        <div class="gist">
                            ...
                            <el-button type="success" plain size="small" v-if="gist.id === session.user.atom">
                    ...
                    <el-col :xs="8" :sm="6" :md="4" :lg="6" :xl="24" v-if="session.user.atom">
    ...
    export default {
        ...
        methods: {
            ...
            selectGist(id) {
                ...
                this.$http.put(`${this.environment.baseUrl}/profile/atom`, payload)
                .then(({ data }) => {
